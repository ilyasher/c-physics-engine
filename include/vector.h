 ...
 *
 * @param v the vector to norm
 * @return unit vector v
 */
...
/**
 * Computes the angle a vector is at from the x axis
 * @param v the vector
...
/* Returns a vector with a modified x. */
Vector vec_set_x(Vector v, double x);

/* Returns a vector with a modified y. */
